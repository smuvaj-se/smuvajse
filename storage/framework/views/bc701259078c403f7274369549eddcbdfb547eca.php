...
<head>
        ...
        <title>SmuvajSe | Registruj se i započni muvanje</title>
                  ...
                  <form name="registration_form" id='registration_form' class="form-inline">
                    <div class="row">
                      <div class="form-group col-xs-6">
                        ...
                        <input id="firstname" class="form-control input-group-lg" type="text" name="firstname" title="Enter first name" placeholder="Ime"/>
                      </div>
                      <div class="form-group col-xs-6">
                        <label for="lastname" class="sr-only">Prezime</label>
                        <input id="lastname" class="form-control input-group-lg" type="text" name="lastname" title="Enter last name" placeholder="Prezime"/>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group gender">
                      <label class="radio-inline">
                        <input type="radio" name="optradio" checked>Muški pol
                      </label>
                      <label class="radio-inline">
                        <input type="radio" name="optradio">Ženski pol
                      </label>
                    </div>
                    <div class="row">
                      <div class="form-group col-xs-6">
                        <label for="city" class="sr-only">First Name</label>
                        <input id="city" class="form-control input-group-lg reg_name" type="text" name="city" title="Enter city" placeholder="Grad"/>
                      </div>
                      <div class="form-group col-xs-6">
